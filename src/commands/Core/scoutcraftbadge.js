...
module.exports = class ScoutcraftBadge extends Command {
  constructor() {
    super({
      name: "scoutcraftbadge",
      aliases: ["scb"],
      category: "Core",
      description: "View a specific scoutcraft badge",
      cooldown: "10s",
      requiresArgs: false,
      guildOnly: false,
      requiresArgs: true
  ...
  async run(msg, args, flags) {
    ...
    if (!badge)
      return m.edit(
        msg.warning("There is no scoutcraft badge with that name!")
      );
